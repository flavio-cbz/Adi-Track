...
interface GradeCoefficientExplainerProps {
    className?: string
}

export function GradeCoefficientExplainer({className}: GradeCoefficientExplainerProps) {
    return (
        <Card>
            ...
            <CardContent className="space-y-4">
                <Alert>
                    ...
                    <AlertDescription>
                        Les coefficients sont appliqués à plusieurs niveaux : note individuelle, module, cours et UE.
                        Chaque niveau
                ...
                <div className="text-sm space-y-2">
                    ...
                    <p>
                        <strong>Niveau 2 - Modules :</strong> Les notes sont d'abord regroupées par module (ex: MATHS1).
                        La moyenne
                        du module est calculée en tenant compte des coefficients des notes.
                    </p>
                    <p>
                        <strong>Niveau 3 - Cours :</strong> Les moyennes des modules sont pondérées par les coefficients
                        des cours
                        pour obtenir la moyenne du cours.
                    </p>
                    <p>
                        <strong>Niveau 4 - UE :</strong> Les moyennes des cours sont pondérées par les coefficients des
                        UE pour
                        obtenir la moyenne de l'UE.
                    </p>
                    <p>
                        <strong>Niveau 5 - Semestre :</strong> Les moyennes des UE sont pondérées par les ECTS pour
                        obtenir la
                        moyenne du semestre.
                    </p>
                </div>
                ...
                <div className="border rounded-md p-4 bg-muted/20">
                    ...
                    <p className="mt-4 text-sm text-muted-foreground">
                        Dans cet exemple, la moyenne du semestre est de 14.03/20, calculée en tenant compte des
                        coefficients à
